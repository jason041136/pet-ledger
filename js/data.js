export const PETS = [
  ...
  {
    id: 'meishi', name: '飽飽', title: '美食家', color: '#E0A24C', deep: '#7E4E14',
    svg: `<svg viewBox="0 0 100 100"><path d="M50 20 C55 20 59 24 63 33 L80 68 C84 76 79 84 70 84 L30 84 C21 84 16 76 20 68 L37 33 C41 24 45 20 50 20Z" fill="#FFFDF5" stroke="#E7DBC0" stroke-width="2"/><path d="M21 66 L79 66 C82 74 79 84 70 84 L30 84 C21 84 18 74 21 66Z" fill="#3B463D"/><circle cx="50" cy="31" r="4" fill="#E36A5B"/><circle cx="31" cy="58" r="4.5" fill="#F4A0A0" opacity="0.6"/><circle cx="69" cy="58" r="4.5" fill="#F4A0A0" opacity="0.6"/><circle cx="40" cy="51" r="5.5" fill="#3A2A18"/><circle cx="60" cy="51" r="5.5" fill="#3A2A18"/><circle cx="42" cy="49" r="2" fill="#fff"/><circle cx="62" cy="49" r="2" fill="#fff"/><path d="M44 60 Q50 65 56 60" stroke="#3A2A18" stroke-width="2.4" fill="none" stroke-linecap="round"/></svg>`
  }
];
